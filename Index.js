...
const server = http.createServer(async (request, response) => {
  ...
  const message = (usePledges) ? `${document.querySelector('[data-tag="CampaignPatronEarningStats-earnings"] h2').innerHTML} USD / MO`.replace(/\$/g, '$ ') : `${document.querySelector('[data-tag="CampaignPatronEarningStats-patron-count"] h2').innerHTML} Patrons`;
